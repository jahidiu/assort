    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid dashboard-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Our Service &nbsp;
                            <a href="{{route('service.create')}}" class="btn btn-primary"> {{__('messages.ln65')}}</a>
                        </h2>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Our Services
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    @php
                                        $i = $data->service->perPage() * ($data->service->currentPage() - 1);
                                        $i++;
                                    @endphp
                                    ...
                                    <tr>
                                         <td>
                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                <input name="ids" value="{{ $service->id }}" type="checkbox"
                                        ...
                                        <td style="width:180px">
                                            <img class="slider-image img-fluid" src="{{ asset('storage/service_image/'.$service->icon) }}" alt="Not Found">
                                        </td>
                                        <td>
                                            @if($service->status == 1)
                                                <a href="{{route('toogle_post_permission',[$service->id])}}"><button class="btn btn-primary btn-sm">Publish</button></a>
                                            @else
                                                <a href="{{route('toogle_post_permission',[$service->id])}}"><button class="btn btn-danger btn-sm">Unpublish</button></a>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a style="text-decoration: none;"
                                                href="{{route('service.edit',[$service->id])}}"><button
