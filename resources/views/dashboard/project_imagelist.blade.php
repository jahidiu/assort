                        ...
                        <div class="page-header">
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('project.imagedropzone')}}" class="dropzone" method="POST"
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <form action="{{ route('project_image.store') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="project_id" value="{{ $data->project->id }}">
                    ...
                    <table class="table table-bordered dtbno">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('project_image.destroy', $image->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
