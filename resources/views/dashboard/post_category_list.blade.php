            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{__('messages.ln151')}}&nbsp;
                        ...
                        <div class="page-breadcrumb">
                            ...
                            <button id="deleteSelectedPostCategories"
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header">
                            ...
                            <form class="float-right d-flex" action="{{route('postcategory_search')}}" method="GET">
                                @csrf
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <div class="modal fade" id="exampleModal-{{$category->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form action="{{route('post_category.update',[$category->id])}}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-content">
                                    ...
                                    <li>
                                        ...
                                        <form class="d-inline"
                                            action="{{route('post_category.destroy',[$category->id])}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        @include('layouts.managepostChild', ['childs' => $category->childrenCategories])
                                        @endif
                                    </li>
                                    @endforeach
                                </ul>
