              ...
              <div class="card-body">
                <form action="{{ route('contactsetting.update', [$data->cs->id]) }}" method="POST">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                      <div class="input-group">
                        ...
                        <input name="email" type="text" class="form-control"
                          placeholder="{{ __('messages.ln163') }}" focus value="{{ $data->cs->email }}">
                      </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                      <div class="input-group">
                        ...
                        <input name="phone" type="text" class="form-control"
                          placeholder="{{ __('messages.ln164') }}" value="{{ $data->cs->phone }}">
                      </div>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                      <div class="input-group">
                        ...
                        <input name="whatsapp_number" type="text" class="form-control"
                          placeholder="WhatsApp Number" value="{{ $data->cs->whatsapp_number }}">
                      </div>
                    </div>
                  ...
                  <div class="form-row float-right">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                      <button class="btn btn-primary" type="submit">{{ __('messages.ln73') }}</button>
                    </div>
                  </div>
