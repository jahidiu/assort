        ...
        <div class="container-fluid dashboard-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title text-primary">{{ __('messages.ln10')}} &nbsp;
                            <a href="{{route('module.create')}}" class="btn btn-primary"> {{__('messages.ln65')}}</a>
                        </h2>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#"
                                            class="breadcrumb-link">{{ __('messages.ln10')}}</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h4 class="card-header text-success">{{ __('messages.ln10')}}
                            <form class="float-right d-flex" action="{{route('module_search')}}" method="GET">
                                @csrf
