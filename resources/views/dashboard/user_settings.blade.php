                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="new_user_register">
                                            <option value="1" @if ($data->usettings->new_user_register == 1)
                                                {{ 'selected' }}
                                                @endif
                                                > ON </option>
                                            <option value="0" @if ($data->usettings->new_user_register == 0)
                                                {{ 'selected' }}
                                                @endif
                                                > OFF </option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="new_user_group">
                                            ...
                                            <option value="{{ $group->id }}" @if ($data->usettings->new_user_group ==
                                                $group->id)
                                                {{ 'selected' }}
                                                @endif
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="new_user_status">
                                            <option value="1" @if ($data->usettings->new_user_status == 1)
                                                {{ 'selected' }}
                                                @endif
                                                >Active</option>
                                            <option value="0" @if ($data->usettings->new_user_status == 0)
                                                {{ 'selected' }}
                                                @endif
                                                >Inactive</option>
                                        </select>
